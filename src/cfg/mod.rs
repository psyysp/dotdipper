...
fn default_exclude_patterns() -> Vec<String> {
    vec![
        ...
        "~/.config/gcloud/default_configs.db".to_string(),
        "~/.config/gcloud/legacy_credentials/**".to_string(),
        "~/.config/gcloud/logs/**".to_string(),
        "~/.config/gcloud/gce".to_string(),
        "~/.config/gcloud/.last_*".to_string(),
        "~/.config/gcloud/config_sentinel".to_string(),
        "~/.config/gcloud/active_config".to_string(),
